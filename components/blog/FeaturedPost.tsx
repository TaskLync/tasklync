      ...
      <div className="mx-auto max-w-[1300px] px-6 sm:px-10 lg:px-16">
        ...
        >
          ...
          <div className="absolute top-5 left-5 z-10">
            <span
              className="font-['Poppins'] px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest text-white"
              style={{
          ...
          {/* Image */}
          <div className="relative w-full lg:w-3/5 h-48 sm:h-64 lg:h-[420px] bg-[#e8f0ec] overflow-hidden">
            {post.featuredImage ? (
              <Image
          ...
          <div className="flex flex-col justify-center p-8 lg:p-12 lg:w-2/5 gap-4">
            ...
            <h2
              className="font-['Fredoka'] font-bold leading-[1.1] tracking-tight"
              style={{
            ...
            <p
              className="font-['Poppins'] leading-[1.7] line-clamp-3"
              style={{
                fontSize: '0.9375rem',
            ...
            />
            <div
              className="font-['Poppins'] flex items-center gap-2 text-[13.5px] font-semibold group-hover:gap-3 transition-all duration-200"
              style={{ color: '#1F6F5F' }}
            >
