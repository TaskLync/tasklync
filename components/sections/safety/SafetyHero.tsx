...
export function SafetyHero() {
  ...
  return (
    <section
      aria-label="Safety at TaskLync"
      className="relative h-[60svh] sm:h-[100svh] min-h-[500px] w-full overflow-hidden"
    >
      {/* Background image */}
      <Image
        src="/images/home/homeowner-trusting-tasklync-professional-home-services.png"
        alt="TaskLync professional and Pakistani homeowner exchanging house keys, representing mutual trust and safety"
        fill
        priority
        loading="eager"
        quality={80}
      ...
      <div className="absolute inset-0 z-20 flex flex-col items-start justify-end px-6 sm:px-10 lg:px-16 pb-14 sm:pb-20">
        ...
        <h1 className="font-['Fredoka'] mb-4 font-bold leading-[1.06] tracking-[-0.01em] text-white text-[clamp(2rem,5.5vw,3.75rem)] max-w-[min(620px,92vw)] drop-shadow-[0_2px_16px_rgba(0,0,0,0.6)]">
          Trust Handed Over,{" "}
          <em className="not-italic text-[#4ECBA5]">Both Ways</em>
        </h1>
        ...
        <p className="font-['Poppins'] mb-8 text-[clamp(0.85rem,1.35vw,1rem)] font-normal leading-[1.6] text-white/70 max-w-[min(420px,85vw)] drop-shadow-[0_1px_8px_rgba(0,0,0,0.5)]">
          Letting someone into your home takes trust. Every TaskLync professional is background checked, verified, and badged, so that trust is never one sided.
        </p>
