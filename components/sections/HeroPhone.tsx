...
// ─── Shared variants ───────────────────────────────────────────────────────────
import { screenTransition, phoneFloat, glowPulse } from "@/lib/motion/variants";
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        transition={{ delay: 0.15, duration: DUR.base + 0.05, ease: [...EASE_EXPO_OUT] }}
      ...
      <motion.div
        ...
        transition={{ delay: 0.3, duration: DUR.base, ease: [...EASE_EXPO_OUT] }}
      ...
      <motion.div
        ...
        animate={{ y: 0, opacity: 1 }}
        transition={{ delay: 0.55, duration: DUR.base, ease: [...EASE_EXPO_OUT] }}
        style={{ width: "100%" }}
      >
        <div
          style={{
        ...
        >
          ...
          <span style={{ color: "#6FCF97" }}>Sign in</span>
        </div>
      </motion.div>
    </motion.div>
  );
...
function SearchScreen() {
  ...
  useEffect(() => {
    if (done) setTimeout(() => setShowResults(true), 350);
  }, [done]);
        ...
        >
          ...
          >
            ...
            {!done && (
              <motion.span
                animate={{ opacity: [1, 0] }}
                transition={{ duration: DUR.fast, repeat: Infinity }}
                style={{
...
function MapPinMarker({ x, y, delay, isUser }: MapPinMarkerProps) {
  return (
    <motion.div
      style={{
        position: "absolute",
      ...
      animate={{ scale: 1, opacity: 1 }}
      transition={{ delay, duration: DUR.fast + 0.08, ease: [...EASE_EXPO_OUT] }}
    >
      {isUser && (
        <motion.div
          style={{
          ...
          transition={{ duration: DUR.cinematic + 0.4, repeat: Infinity, ease: "easeOut" }}
        />
      )}
      <div
        style={{
          ...
          borderRadius: "50%",
          background: isUser
            ? "linear-gradient(135deg,#1F6F5F,#2FA084)"
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          animate={{ y: 0, opacity: 1 }}
          transition={{ delay: 1.2, duration: DUR.base - 0.05, ease: [...EASE_EXPO_OUT] }}
          style={{
            position: "absolute",
            bottom: 10,
            left: "50%",
    ...
    >
      ...
      <div style={{ flex: 1, overflowY: "hidden", padding: "0 14px 14px" }}>
        <motion.div
          ...
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: DUR.base - 0.05, ease: [...EASE_EXPO_OUT] }}
          style={{
            borderRadius: 20,
            border: "1px solid rgba(255,255,255,0.1)",
            background: "rgba(255,255,255,0.04)",
        ...
        >
          ...
          >
            {stats.map(({ Icon, val, lbl, iconColor }) => (
              <div
                key={lbl}
                style={{
                  borderRadius: 12,
          ...
          >
            ...
            >
              Car mechanic · Diagnostic + Repair
            </div>
          </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <motion.div
            initial={{ scale: 0, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            transition={{ delay: 0.25, duration: DUR.base - 0.05, ease: [...EASE_EXPO_OUT] }}
          >
      ...
      <motion.div
        ...
        animate={{ y: 0, opacity: 1 }}
        transition={{ delay: 0.35, duration: DUR.base, ease: [...EASE_EXPO_OUT] }}
      ...
      <motion.div
        initial={{ y: 10, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ delay: 0.6, duration: DUR.base, ease: [...EASE_EXPO_OUT] }}
        style={{
          width: "100%",
          borderRadius: 18,
      ...
      >
        ...
        >
          <motion.div
            ...
            initial={{ width: "0%" }}
            animate={{ width: "35%" }}
            transition={{ delay: 0.85, duration: DUR.slow + 0.3, ease: "easeOut" }}
          />
        </div>
        <div
          style={{
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        height: 560,
        filter:
          "drop-shadow(0 40px 80px rgba(0,0,0,0.75)) drop-shadow(0 0 40px rgba(47,160,132,0.18))",
      }}
    >
      {/* Ambient glow pulse — steady-state loop handled by glowPulse variant */}
      <motion.div
        variants={glowPulse}
        animate="pulse"
        style={{
          ...
          inset: -20,
          borderRadius: 60,
          background: "radial-gradient(ellipse at 50% 60%, rgba(47,160,132,0.12) 0%, transparent 70%)",
          pointerEvents: "none",
          zIndex: -1,
        }}
      />
      ...
      <div
        style={{
          ...
          boxShadow:
            "inset 0 1px 0 rgba(255,255,255,0.09), inset 0 -1px 0 rgba(0,0,0,0.5), 0 0 0 1px rgba(0,0,0,0.9)",
        }}
      >
        {/* Screen bezel */}
        <div
        ...
        >
          ...
          <div
            style={{
              ...
              pointerEvents: "none",
              background:
                "linear-gradient(135deg,rgba(255,255,255,0.055) 0%,transparent 45%,transparent 60%,rgba(255,255,255,0.018) 100%)",
            }}
          />
        </div>
