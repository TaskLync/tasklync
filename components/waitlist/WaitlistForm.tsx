...
export function WaitlistForm({
  ...
  /**
   * On mobile: skip all enter/exit animations by passing static
   * initial/animate objects so Framer Motion renders immediately.
   * On desktop: use the original staggered fadeUp variants as before.
   */
  const motionProps = (custom: number) =>
    isMobile
      ? { initial: { opacity: 1, y: 0 }, animate: { opacity: 1, y: 0 } }
      : { variants: fadeUp, initial: "hidden" as const, animate: "visible" as const, custom };
    ...
    >
      ...
      >
        ...
        <span
          style={{
            backgroundImage:
              "linear-gradient(100deg,#1F6F5F 0%,#2FA084 60%,#6FCF97 100%)",
        ...
        <input
          ...
          onFocus={(e) => {
            ...
            e.currentTarget.style.boxShadow =
              "0 0 0 3px rgba(47,160,132,0.12)";
          }}
          onBlur={(e) => {
      ...
      <motion.button
        ...
        style={{
          ...
          boxShadow:
            "0 0 28px rgba(47,160,132,0.2), inset 0 1px 0 rgba(255,255,255,0.1)",
