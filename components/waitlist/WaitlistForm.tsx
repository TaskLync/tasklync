  ...
  return (
    <motion.div key="form" initial={{ opacity: 1 }} exit={{ opacity: 0 }}>
      ...
      <motion.p
        ...
        style={{ fontFamily: "var(--font-body)", fontSize: "0.875rem", color: "rgba(13,31,28,0.5)" }}
      >
      ...
      >
        ...
        <input
          ...
          onBlur={(e) => {
            e.currentTarget.style.border = error ? "1.5px solid #E05252" : "1.5px solid rgba(13,31,28,0.12)";
      ...
      <motion.button
        ...
        style={{
          fontFamily: "var(--font-body)",
          background: loading ? "rgba(31,111,95,0.6)" : "linear-gradient(135deg,#1F6F5F 0%,#2FA084 100%)",
          boxShadow: "0 0 28px rgba(47,160,132,0.2), inset 0 1px 0 rgba(255,255,255,0.1)",
          cursor: loading ? "not-allowed" : "pointer",
        }}
      >
        {loading ? (
          <><Loader2 size={14} strokeWidth={2.2} className="animate-spin" />Joining…</>
        ) : (
